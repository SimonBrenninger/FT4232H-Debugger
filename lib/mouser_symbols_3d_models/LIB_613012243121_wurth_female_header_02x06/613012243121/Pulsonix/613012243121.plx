...
//1408757/896458/2.50/12/4/Connector
...
(library Library_1
	...
	(patternDef "613012243121" (originalName "613012243121")
		(multiLayer
			(pad (padNum 1) (padStyleRef c160.5_h107) (pt 0.000, 0.000) (rotation 90))
			(pad (padNum 2) (padStyleRef c160.5_h107) (pt 0.000, 2.540) (rotation 90))
			(pad (padNum 3) (padStyleRef c160.5_h107) (pt 2.540, 0.000) (rotation 90))
			(pad (padNum 4) (padStyleRef c160.5_h107) (pt 2.540, 2.540) (rotation 90))
			(pad (padNum 5) (padStyleRef c160.5_h107) (pt 5.080, 0.000) (rotation 90))
			(pad (padNum 6) (padStyleRef c160.5_h107) (pt 5.080, 2.540) (rotation 90))
			(pad (padNum 7) (padStyleRef c160.5_h107) (pt 7.620, 0.000) (rotation 90))
			(pad (padNum 8) (padStyleRef c160.5_h107) (pt 7.620, 2.540) (rotation 90))
			(pad (padNum 9) (padStyleRef c160.5_h107) (pt 10.160, 0.000) (rotation 90))
			(pad (padNum 10) (padStyleRef c160.5_h107) (pt 10.160, 2.540) (rotation 90))
			(pad (padNum 11) (padStyleRef c160.5_h107) (pt 12.700, 0.000) (rotation 90))
			(pad (padNum 12) (padStyleRef c160.5_h107) (pt 12.700, 2.540) (rotation 90))
		)
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 6.350, -3.359) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.52 -1.56) (pt 14.22 -1.56) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 14.22 -1.56) (pt 14.22 -10.06) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 14.22 -10.06) (pt -1.52 -10.06) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.52 -10.06) (pt -1.52 -1.56) (width 0.025))
		)
		(layerContents (layerNumRef 18)
			(line (pt -1.52 -1.56) (pt 14.22 -1.56) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt 14.22 -1.56) (pt 14.22 -10.06) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt 14.22 -10.06) (pt -1.52 -10.06) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt -1.52 -10.06) (pt -1.52 -1.56) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -2.52 4.342) (pt 15.22 4.342) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 15.22 4.342) (pt 15.22 -11.06) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 15.22 -11.06) (pt -2.52 -11.06) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -2.52 -11.06) (pt -2.52 4.342) (width 0.1))
		)
	)
	(symbolDef "613012243121" (originalName "613012243121")
	...
	(compDef "613012243121" (originalName "613012243121") (compHeader (numPins 12) (numParts 1) (refDesPrefix J)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "613012243121"))
		(attachedPattern (patternNum 1) (patternName "613012243121")
			(numPads 12)
			(padPinMap
		...
		(attr "Mouser Part Number" "710-613012243121")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Wurth-Elektronik/613012243121?qs=iLbezkQI%252Bsgb444HYkTruQ%3D%3D")
		(attr "Manufacturer_Name" "Wurth Elektronik")
		(attr "Manufacturer_Part_Number" "613012243121")
		(attr "Description" "WURTH ELEKTRONIK - 613012243121 - CONNECTOR, RCPT, 12POS, 2ROW, 2.54MM")
		(attr "<Hyperlink>" "")
		(attr "<Component Height>" "5.23")
		(attr "<STEP Filename>" "613012243121.stp")
